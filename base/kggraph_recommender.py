...
from data.knowledge import KnowledgeInteraction
...
class KGGraphRecommender(Recommender):
    def __init__(self, conf, training_set, test_set, **kwargs):
        super(KGGraphRecommender, self).__init__(conf, training_set, test_set, **kwargs)
        self.data = KnowledgeInteraction(conf, training_set, test_set)
